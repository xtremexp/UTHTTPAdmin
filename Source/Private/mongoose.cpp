...
#endif
// C:/Program Files (x86)/Microsoft Visual Studio 12.0/VC/include\sys\types.h
#include <sys/types.h>
#include <sys/stat.h>
#include <assert.h>
#include <ctype.h>
...
#pragma comment(lib, "Ws2_32")    // Linking with winsock library
#include <BaseTsd.h>
...
static process_id_t start_process(char *interp, const char *cmd,
	...
	uint32 flags = DUPLICATE_CLOSE_SOURCE | DUPLICATE_SAME_ACCESS;
	FILE *fp;
